        ...
        button.setOnClickListener(
                v -> {
                    if (audioManager.isWiredHeadsetOn()) {
                        ...
                        if (again >= 100)
                            textview.setText("Try physically repairing your phone.");
                        else if (again >= 10)
                            textview.setText("Headset is unplugged, try troubleshooting more.");
                        else if (again >= 1)
                            textview.setText("Headset is unplugged, try troubleshooting again.");
                        else
                            textview.setText("Headset is unplugged, try troubleshooting.");
